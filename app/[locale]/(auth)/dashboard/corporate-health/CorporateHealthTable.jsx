...
import CorporateHealthFormModal from "./CorporateHealthFormModal";
...
// Endpoint layanan
const LIST_PATH = "/upload/corporate-health";
const DELETE_PATH = "/upload/corporate-health";
...
/* =========================
   Main Table
========================= */
export default function CorporateHealthTable() {
  ...
  const onDelete = async (item) => {
    if (!confirm(`Delete service "${item.key}"? This cannot be undone.`))
      return;
    try {
