...
const CREATE_PATH = "/upload/corporate-health";
const UPDATE_PATH = "/upload/corporate-health";
...
/* =====================
   Component
===================== */
export default function CorporateHealthFormModal({
  open,
  onClose,
      ...
      <div className="w-full max-w-4xl rounded-2xl bg-white p-6 shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-slate-900">
            {isEdit ? "Edit Corporate Health" : "Tambah Corporate Health"}
          </h3>
          <button
            onClick={onClose}
