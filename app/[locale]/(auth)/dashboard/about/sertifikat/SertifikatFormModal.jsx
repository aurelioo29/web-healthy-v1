...
const CREATE_PATH = "/upload/about-us-sertifikat";
const UPDATE_PATH = "/upload/about-us-sertifikat";
...
export default function SertifikatFormModal({
  open,
  onClose,
  mode = "create",
  initialData = null,
      ...
      <div className="w-full max-w-3xl rounded-2xl bg-white p-6 shadow-xl max-h-[90vh] overflow-y-auto">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-slate-900">
            {isEdit ? "Edit Sertifikat" : "Add Sertifikat"}
          </h3>
          <button
            onClick={onClose}
            ...
            <input
              ...
              className={`mt-1 w-full rounded-lg ring-1 px-3 py-2 text-sm outline-none ${
                errors.title
                  ...
                  : "ring-slate-200 focus:ring-sky-400"
              }`}
