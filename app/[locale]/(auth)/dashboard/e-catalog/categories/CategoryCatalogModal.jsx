...
export default function CategoryCatalogFormModal({
  open,
  onClose,
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (mode === "edit" && initialData?.id) {
        await api.put(`/upload/category-catalogs/${initialData.id}`, payload);
      } else {
        await api.post(`/upload/category-catalogs`, payload);
      }
    ...
    >
      ...
      >
        <h3 className="text-lg font-bold">
          {mode === "edit" ? "Edit Catalog Category" : "New Catalog Category"}
        </h3>
        ...
        <div className="mt-4 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Contoh: Pemeriksaan NIPT"
            />
