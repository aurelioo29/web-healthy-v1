...
// Ganti ke endpoint layanan klinik kamu
const CREATE_PATH = "/upload/layanan-klinik";
const UPDATE_PATH = "/upload/layanan-klinik";
...
/* =====================
   Component
===================== */
export default function LayananKlinikFormModal({
  open,
  onClose,
