...
import CorporateHealthBlock from "./CorporateHealthBlock";
...
export default function ClinicServices({ tNs = "vitamin" }) {
  const locale = useLocale();
  const t = useTranslations(tNs); // pastikan ada keys: cta, ctaHref
