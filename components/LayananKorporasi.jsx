...
export default function LayananKorporasi() {
  const t = useTranslations("layananKorporasi");
      ...
      <div className="mx-auto grid max-w-7xl items-start gap-6 px-4 md:grid-cols-2 md:gap-8 md:px-6">
        <div className="relative md:order-1">
          ...
          <div className="relative overflow-hidden rounded-3xl ring-1 ring-black/5">
            <Image
              src="/images/corporate-pages/layanan-koperasi.webp"
              alt={t("imageAlt")}
              width={1280}
              height={860}
        ...
        <div className="relative md:order-2 my-auto md:right-28 md:top-9">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-xl ring-1 ring-black/5 md:p-8">
            ...
            <ol className="mt-6 list-decimal space-y-1 pl-5 text-slate-900">
              <li>{t("items.0")}</li>
              <li>{t("items.1")}</li>
              <li>{t("items.2")}</li>
              <li>{t("items.3")}</li>
