...
export default function HomecareInfo() {
  const t = useTranslations("homecareInfo");
      ...
      <div className="mx-auto grid max-w-7xl items-start gap-6 px-4 md:grid-cols-2 md:gap-8 md:px-6">
        <div className="relative md:order-1">
          ...
          <div className="relative overflow-hidden rounded-3xl ring-1 ring-black/5">
            <Image
              src="/images/homecare-pages/Info.webp"
              alt={t("imageAlt")}
              width={1280}
              height={860}
        ...
        <div className="relative md:order-2 my-auto">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-xl ring-1 ring-black/5 md:p-8">
            ...
            <div className="mt-16">
              <Link
                href={t("ctaHref")}
                className="inline-flex items-center justify-center rounded-lg bg-gradient-to-br from-[#17767C] via-[#2B8C6D] to-[#349468] px-5 py-2.5 text-white transition hover:bg-[#3b86cf]"
              >
                {t("cta")}
              </Link>
            </div>
