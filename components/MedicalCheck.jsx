...
export default function MedicalCheck() {
  const t = useTranslations("medicalCheck");

  return (
    <section className="py-12 md:py-16">
      <div className="mx-auto grid max-w-7xl items-end gap-6 px-4 md:grid-cols-2 md:gap-8 md:px-6">
        <div className="relative order-3 md:order-1 my-auto md:left-28 z-10">
          {/* DESKTOP: pill judul mengambang */}
          <div className="pointer-events-none absolute -top-7 left-8 z-10 hidden md:block">
        ...
        <div className="relative order-1 md:order-1">
          ...
          <div className="relative overflow-hidden rounded-3xl ring-1 ring-black/5">
            <Image
              src="/images/corporate-pages/medical-checkup.webp"
              alt={t("imageAlt")}
              width={1280}
              height={860}
